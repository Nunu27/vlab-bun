...
| `node-interface.check-ip` | `R1` | **ip**: 10.10.30.1/30<br>**interface**: ether4 | 1 |
...
| `node-interface.check-ip` | `R3` | **ip**: 10.10.30.2/30<br>**interface**: ether4 | 1 |
...
| `mikrotik.ospf-interface-template-exist` | `R1` | **area**: backbone-lab<br>**interfaces**: ether4<br>**type**: ptp<br>**cost**: 50 | 3 |
...
| `mikrotik.ospf-interface-template-exist` | `R3` | **area**: backbone-lab<br>**interfaces**: ether4<br>**type**: ptp<br>**cost**: 50 | 3 |
...
| `mikrotik.route-exist` | `R1` | **dst**: 192.168.20.0/24<br>**gateway**: 10.10.10.2<br>**flag**: DAo | 4 |
| `mikrotik.route-exist` | `R3` | **dst**: 192.168.10.0/24<br>**gateway**: 10.10.20.1<br>**flag**: DAo | 4 |
