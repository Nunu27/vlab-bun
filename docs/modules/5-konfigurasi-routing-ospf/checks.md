...
| `mikrotik.ospf-interface-template-exist` | `R2` | **area**: backbone-lab<br>**interfaces**: ether2<br>**passive**: yes | 2 |
...
| `mikrotik.ospf-neighbor-exist` | `R2` | **state**: Full<br>**interface**: ether3 | 2 |
| `mikrotik.route-exist` | `R1` | **dst**: 192.168.20.0/24<br>**flag**: DAo | 2 |
| `mikrotik.route-exist` | `R2` | **dst**: 192.168.10.0/24<br>**flag**: DAo | 2 |
