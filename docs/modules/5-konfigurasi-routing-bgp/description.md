...
**Prasyarat:** Modul ini melanjutkan **Modul 4: Konfigurasi Routing OSPF**, karena di sini dibahas perbedaan mendasar antara IGP (di dalam satu organisasi) dan EGP (antar-organisasi).
