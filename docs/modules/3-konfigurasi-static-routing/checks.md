...
| \`mikrotik.route-exist\` | \`R2\` | **dst**: 192.168.10.0/24<br>**gateway**: 10.10.10.1<br>**flag**: As | 1 |
| \`mikrotik.route-exist\` | \`R1\` | **dst**: 192.168.20.0/24<br>**gateway**: 10.10.10.2<br>**flag**: As | 1 |
