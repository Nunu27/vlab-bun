...
3. Interface **ether2** pada R1 dan R3 dikonfigurasi dengan `passive`. Apa yang terjadi jika parameter tersebut dihilangkan, dan mengapa jaringan LAN-nya tetap muncul di tabel rute router lain meskipun interface-nya pasif?
