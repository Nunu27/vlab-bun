...
2. Pada Modul 2, rute harus ditulis di setiap router secara manual, termasuk rute balikannya. Pada modul ini tidak ada satu rute pun yang ditulis, tetapi PC1 tetap bisa menghubungi PC2. Apa yang menggantikan pekerjaan manual tersebut?
