...
export const WorkerSpec: MessageFns<WorkerSpec> = {
	encode(
		...
		if (message.guacdHost !== "") {
			writer.uint32(34).string(message.guacdHost);
		}
		if (message.guacdPort !== 0) {
			writer.uint32(40).int32(message.guacdPort);
		}
		return writer;
	},
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 4: {
					...
					message.guacdHost = reader.string();
					continue;
				}
				case 5: {
					if (tag !== 40) {
					...
					message.guacdPort = reader.int32();
					continue;
				}
			}
			if ((tag & 7) === 4 || tag === 0) {
		...
		return {
			...
			storageMb: isSet(object.storageMb)
				...
				: isSet(object.storage_mb)
					...
					: 0,
			guacdHost: isSet(object.guacdHost)
				? globalThis.String(object.guacdHost)
				: isSet(object.guacd_host)
					? globalThis.String(object.guacd_host)
					: "",
			guacdPort: isSet(object.guacdPort)
				? globalThis.Number(object.guacdPort)
				: isSet(object.guacd_port)
					? globalThis.Number(object.guacd_port)
					: 0,
		};
	},
	...
	toJSON(message: WorkerSpec): unknown {
		...
		if (message.guacdHost !== "") {
			obj.guacdHost = message.guacdHost;
		}
		if (message.guacdPort !== 0) {
			obj.guacdPort = Math.round(message.guacdPort);
		}
		return obj;
	},
	...
	fromPartial(object: DeepPartial<WorkerSpec>): WorkerSpec {
		...
		message.guacdHost = object.guacdHost ?? "";
		message.guacdPort = object.guacdPort ?? 0;
		return message;
	},
};
