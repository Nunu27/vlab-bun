...
export default function PropertiesPanel() {
  ...
  const isDuplicateName = useMemo(() => {
    ...
    const nameToCheck =
      primarySelection.type === 'device' || primarySelection.type === 'group'
      ...
      <div className="flex-1 space-y-6 overflow-y-auto p-5">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              {isGroup ? 'Group Name' : isNote ? 'Content' : 'Device Name'}
            </FieldLabel>
            ...
            {isNote ? (
              <textarea
                ...
                onChange={(e) =>
                  setNodes((ns) =>
                    ns.map((n) =>
                      n.id === primarySelection.id && n.type === 'note'
              ...
              <Input
                type="text"
                value={
                  primarySelection.type === 'device' ||
                  primarySelection.type === 'group'
                    ? primarySelection.name
                    : ''
                }
          ...
          {isGroup && primarySelection.type === 'group' && (
            <div className="dark:border-border space-y-2 border-t border-gray-100 pt-2">
              <FieldLabel className="dark:text-muted-foreground flex items-center gap-2 text-xs font-semibold tracking-wide text-gray-500 uppercase">
                <PaletteIcon size={12} /> Group Color
              </FieldLabel>
